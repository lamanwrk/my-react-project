  ...
  const sliderData = [
    {
      ...
      h2: "and Chocolate",
      description: "Traditional hand-dipping techniques that create truly unique confections. We offer handmade chocolates, truffles, caramels and more.",
      button: "Read more"
    },
    {
      img: img2,
      ...
      h2: "with Love",
      description: "Our handmade sweets are made using traditional methods, ensuring an unforgettable taste and experience.",
      button: "Read more"
    },
    {
      img: img3,
      ...
      description: "Enjoy our unique selection of handmade truffles, perfect for gifting or personal indulgence.",
      button: "Read more"
    },
    {
      img: img4,
      ...
      description: "Celebrate life's sweet moments with our delightful and freshly made confectioneries.",
      button: "Read more"
    }
  ];  
  ...
  return (
    <div className="changeimg">
      ...
      <div className="text">
        ...
        <button className="generalButton">{sliderData[currentIndex].button}</button>
      </div>
    </div>
  );
};
